...
<body>
    ...
    <div class="info">
      ...
      <div class="right">
        ...
        <div class="right_number_container">
          <div class="right_number"> <span class="number_title"> Approved Number:</span><span
              id="approvedNumber">0</span></div>
          <div class="left_number"><span class="number_title"> Denied Number:</span><span id="deniedNumber">0</span>
          </div>
        </div>
  ...
  <script>
    let data = [
      { name: "xxx", status: "approve" },
      { name: "xxx2", status: "denied" },
      { name: "xxx", status: "approve" },
      { name: "xxx2", status: "denied" },
    ]
    ...
    function initLoad() { //初始化
      ...
      let approvedNumber = 0, deniedNumber = 0;
      data.forEach(item => {
      ...
      $("#approvedNumber").html(approvedNumber)
      $("#deniedNumber").html(deniedNumber)
      ...
      data.forEach((item, idx) => {
        html += `
            <div class="item item_list">
                ...
                <button type="button" class="btn btn-link item_list_btn" data_val=${idx} data-toggle="modal" data-target="#modal1">Process</button>
            </div>
          `
      });
      console.log("render")
      $("#right_container").html(html) //再渲染
    }
    ...
    function addEvent() { //绑定事件
      ...
      for (let i = 0; i < len; i++) {
        ...
        $dom.on("click", function () {
          ...
          let { name, status } = data[idx]

          setConfig(idx)

          $("#userInfo").text(name) //设置 模态框的值
