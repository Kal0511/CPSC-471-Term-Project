...
<body>
  <div id="page">
    ...
    <div class="info">
      ...
      <div class="right">
        ...
        <div class="right_number_container">
          <div class="right_number"> <span class="number_title"> Incidents handled Number:</span><span id="handledNumber">0</span></div>
          <!-- <div class="left_number">Denied Number:12345789</div> -->
        </div>
        <div class="right_container" id="right_container">
          ...
          <!-- <div class="item item_list">
            ...
            <button type="button" class="btn btn-link item_list_btn" data-toggle="modal"
              data-target="#modal1">Process</button>
          </div> -->
  ...
  <script>
    let data=[
      {name:"xxx",status:"approve",incidentsReport:"xxxxxxxxxdoing   da ta     ran hou  over"},
      {name:"xxx2",status:"denied",incidentsReport:"yyyyyyyyydoing   da ta     ran hou  over"},
      {name:"xxx3",status:"approve",incidentsReport:"zzzzzzzzzdoing   da ta     ran hou  over"},
      {name:"xxx4",status:"denied",incidentsReport:"xxxxxxxxxdoing   da ta     ran hou  over"},
    ]
    ...
    function addEvent(){ //绑定事件
      ...
      for(let i=0;i<len;i++){
        ...
        $dom.on("click",function(){
          ...
          let {name,status,incidentsReport} = data[idx]

          setConfig(idx)

          $("#incidentsReport").text(incidentsReport) //设置 模态框的值
    ...
    function changeData(event){
        //改变完数据 就需要重新渲染dom
        data[config.activeIdx].status = $("#select_status").val()
